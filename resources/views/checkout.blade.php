                        ...
                        <div class="sticky-content">
                                ...
                                @if (Session::has('discounts'))
                                    <table class="checkout-totals">
                                        <tbody>
                                            ...
                                            <tr>
                                                <th>DISCSOUNT {{ Session::get('coupon')['code'] }}</th>
                            ...
                            <div class="checkout__payment-methods">
                                ...
                                <p class="option-detail">
                                    Your order will not be proccesed until you completed your payment.
                                </p>
                            ...
                            <button type="button" class="btn btn-primary btn-checkout" id="pay-button">PLACE ORDER</button>
                        </div>
                    </div>
                </div>
                <form>
...
@section('scripts')
    ...
    <script>
        document.getElementById('pay-button').onclick = function() {
            ...
            var snapToken = '{{ $snapToken }}'; // Ambil snapToken dari Blade (pastikan sudah benar)
            snap.pay(snapToken, {
                // Optional

                onSuccess: function(result) {
                    alert('Pembayaran berhasil! Order Anda akan diproses.');
                    // Kirim form secara otomatis untuk menjalankan route cart.place.an.order
