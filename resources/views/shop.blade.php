                ...
                <div class="accordion" id="categories-filters">
                    <div class="accordion-item mb-4 pb-3">
                        ...
                        <div id="accordion-filter-category" class="accordion-collapse collapse show border-0"
                            aria-labelledby="accordion-heading-category" data-bs-parent="#categories-list">
                            <div class="search-field multi-select accordion-body px-0 pb-0 pt-3">
                    ...
                    <div class="accordion-item mb-4">
                        ...
                        <div id="accordion-filter-price" class="accordion-collapse collapse show border-0"
                            ...
                            <input class="price-range-slider" type="text" name="price_range" value=""
                                data-slider-min="0" data-slider-max="200000" data-slider-step="5"
                        ...
                        <div class="product-card-wrapper">
                            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
                                <div class="pc__img-wrapper">
                                    <div class=" background-img js-swiper-slider"
                                    ...
                                    @if (Cart::instance('cart')->content()->where('id', $product->id)->count() > 0)
                                        <a href="{{ route('cart.index') }}"
                                            class="pc__atc btn anim_appear-bottom btn position-absolute border-0 text-uppercase fw-medium btn-warning mb-3">Pergi
                                            Ke Keranjang</a>
                                    @else
                                        <form name="addtocart-form" method="post" action="{{ route('cart.add') }}">
                                            ...
                                            <button type="submit"
                                                ...
                                                data-aside="cartDrawer" title="Tambahkan Keranjang">Tambahkan
                                                Keranjang</button>
                                        </form>
                                    @endif
                                </div>
    ...
    <script>
        $(function() {
            ...
            $("input[name='categories']").on("change", function() {
                ...
                $("#hdnCategories").val(categories); // Perbaikan: Gunakan 'categories' bukan 'brands'
                $("#frmfilter").submit();
            })
